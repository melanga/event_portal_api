...
CREATE TABLE customer (
    ...
    CONSTRAINT customer_user_id_fk FOREIGN KEY (user_id) REFERENCES user(id) ON DELETE CASCADE,
);
...
CREATE TABLE service_provider(
    ...
    user_id uuid NOT NULL,
    CONSTRAINT service_provider_user_id_fk FOREIGN KEY (user_id) REFERENCES user(id) ON DELETE CASCADE,
);
